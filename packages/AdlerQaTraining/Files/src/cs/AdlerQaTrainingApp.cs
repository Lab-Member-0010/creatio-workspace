...
namespace AdlerQaTrainingApp {
	...
	/// This is the MAIN entry point into the AdlerQaTrainingApp package.
	/// </summary>
	public sealed class AdlerQaTrainingApp {

		#region Fields: Private

		private static Lazy<AdlerQaTrainingApp> _instance = new Lazy<AdlerQaTrainingApp>(() => new AdlerQaTrainingApp());
		...
		public static AdlerQaTrainingApp Instance => _instance.Value;
		...
		/// </summary>
		/// <returns></returns>
		internal AdlerQaTrainingApp Reset(){
			_serviceProvider.Value?.Dispose();
			_instance = null;
			_instance = new Lazy<AdlerQaTrainingApp>(() => new AdlerQaTrainingApp());
